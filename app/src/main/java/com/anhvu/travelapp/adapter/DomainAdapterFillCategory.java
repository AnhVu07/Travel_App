...
public class DomainAdapterFillCategory extends RecyclerView.Adapter<DomainAdapterFillCategory.ViewHolder> {

    ArrayList<Domains> domains;
    DecimalFormat decimalFormat;

    public DomainAdapterFillCategory(ArrayList<Domains> domains) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_holder_domain_for_category,parent,false);
        return new DomainAdapterFillCategory.ViewHolder(inflate);
    }
